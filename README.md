...
[![version](https://img.shields.io/badge/version-1.3-red.svg)](https://semver.org)

## About
This repo contains the older version of the annotation tool TIARA. Please visit [this link](https://github.com/wiragotama/TIARA-annotationTool) for the latest version. The old version is kept for compatibility purpose (who knows if people already used this version).

## Description

This is the TIARA annotation tool described in [our paper at LREC2020](http://www.lrec-conf.org/proceedings/lrec2020/pdf/2020.lrec-1.854.pdf). Please kindly cite the following paper when you use this tool. **You can use this tool freely**, but it would be appreciated if you could send me a courtesy [email](https://wiragotama.github.io) so I could survey what kind of tasks the tool is used for. 
...
- Live demo: <https://wiragotama.github.io/TIARAv1/> (since this is a **client-side** tool, your data (essay) will not be uploaded, i.e., stays in your computer locally)
